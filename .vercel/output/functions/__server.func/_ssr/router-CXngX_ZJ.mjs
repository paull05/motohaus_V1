...
var styles_default = "/assets/styles-m6oN_TVZ.css";
var APP_NAME = "MotoHaus Parts";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "MotoHaus Parts — motorcycle parts shop management: inventory, POS, fitment, service bay, and live reports."
			}
		],
		links: [
			{
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@500&family=Inter:wght@400;500;600;700;800&display=swap"
			}
		]
	}),
